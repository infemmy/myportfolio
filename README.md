...
- No server-side software or package installation is required
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/infemmy/myportfolio.git
   ```
...
[https://github.com/infemmy/myportfolio](https://github.com/infemmy/myportfolio)
